...
- **Self-spreading**: once the planet holds **≥5°C and ≥8% O₂**, moss, shrubs and tree canopies seed lichen onto adjacent bare regolith on their own (seeds fall up to ~7 blocks to find ground). It's self-limiting: seeds refuse ground that already has **4+ plants within 2 blocks**, and at most **2 seeds take root planet-wide per second** — so wild growth creeps outward at forest edges instead of cascading into a carpet.
