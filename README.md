...
- **Self-spreading**: once the planet holds **≥5°C and ≥8% O₂**, moss, shrubs and tree canopies seed lichen onto adjacent bare regolith on their own (seeds fall up to ~7 blocks to find ground). Early terraforming is hand-planted; a warm half-breathable world starts finishing the job itself.
